...
public class VolumeConverterGUI
  ...
  private class NewGallonsValue
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        double gallonsValue = Double.parseDouble
            (gallonsField.getText());
        double litersValue =
  ...
  private class NewLitersValue
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        double litersValue = Double.parseDouble
            (litersField.getText());
        double gallonsValue =
